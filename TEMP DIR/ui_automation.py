...
# =============================================================================
# 21-STEP CUSTOM SEQUENCE CONFIGURATION
# =============================================================================
# Adjust coordinates (X, Y) for each step below.
# Use get_coords.py to find the right pixels.
# =============================================================================
COORDS = {
    "step-1": (874, 584),   # Click: Change Launcher Login
    "step-2": (845, 626),   # Click: Sign in with different account
    "step-4": (801, 628),   # Click: Microsoft Account (Click 1)
    "step-5": (949, 701),   # Click: Microsoft Account (Click 2)
    "step-7": (977, 546),   # Click: Next after Email
    "step-9": (776, 566),   # Click: Sign In after Password
    "step-11": (971, 710),  # Click: Send Code for 2FA
    "step-11b": (826, 452), # Click: 11b (NEW)
    "step-13": (971, 577),  # Click: Verify Code after 2FA
    "step-14": (985, 770),  # Click: PIN Field / OK
    "step-16": (832, 715),  # Click: Save and Continue
    "step-17": (819, 534),  # Click: Privacy Step 1
    "step-18": (964, 640),  # Click: Privacy Step 2
    "step-19": (833, 789),  # Click: Let's Go
    "step-20": (1307, 675),  # Click: Post-Launch 1
    "step-21": (842, 689) # Click: Post-Launch 2
}

# ADJUST DELAYS (Seconds) - Timers happen BEFORE the action starts.
DELAYS = {
    "init": 1,
    "step-1": 8,
    "step-2": 8,
    "step-3": 4,   # Scroll delay
    "step-4": 2,
    "step-5": 1,
    "step-6": 5,   # Email typing delay
    "step-7": 2,
    "step-8": 3,   # Password typing delay
    "step-9": 2,
    "step-10": 3,  # 2FA Email typing delay
    "step-11": 2,
    "step-11b": 2, # 11b delay
    "step-12": 15,  # 2FA Code poll/typing delay
    "step-13": 5,
    "step-14": 5,
    "step-15": 2,  # PIN typing delay
    "step-16": 15,
    "step-17": 8,
    "step-18": 2,
    "step-19": 3,
    "step-20": 30, # Longer wait for Bedrock to open
    "step-21": 5
}
...
def countdown(step_key):
    """Visible countdown timer using the key from DELAYS."""
